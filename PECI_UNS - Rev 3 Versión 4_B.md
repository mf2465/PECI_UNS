...
| 0 | 3 | 09/2026 | Reestructuración editorial para lectura jerárquica (títulos, secciones y tablas) e integración del Plan de Telecomunicaciones Operacionales (POT-RACUNS), adaptado del "Plan de Telecomunicaciones Operacionales para Apoyo Federal" v1.0/2026 (Plan de Coordinación Federal ENOS 2026/2027, AFE–DNOYL) |
...
Este documento es de uso obligatorio para: **Dirección General de Telecomunicaciones**, **Subsecretaría de Infraestructura y Servicios**, **Laboratorio de Hidráulica del Departamento de Ingeniería (LH)**, **mayordomías de todos los predios**, **Seguridad Patrimonial** y **brigadas técnicas**.
...
8. **PLAN DE TELECOMUNICACIONES OPERACIONALES PARA APOYO FEDERAL** v1.0/2026 (Plan ENOS 2026/2027, AFE–DNOYL) – marco de referencia del POT-RACUNS (Sección 5).
...
| **Edificio Anexo Radio AM UNS (Anexo Radio)** | Cadena de transmisión AM y nodo de comunicaciones; Sala de Crisis alternativa | Respaldo energético verificado según 4.13; inclusión en prueba radial semanal y en pruebas de campo |
...
- **Radiobase VHF del Laboratorio de Hidráulica (BASE LH):** equipo fijo existente en el LH del Departamento de Ingeniería; opera como nodo técnico de la red y respaldo del troncal (ver 4.8).
...
| **BASE LH** | Laboratorio de Hidráulica, Departamento de Ingeniería | Nodo técnico y respaldo del troncal (4.8) |
| **ANEXO RADIO (Campus Radio)** | Edificio Anexo de la Radio AM UNS | Radiobase fija bibanda integrada al troncal; **Sala de Crisis alternativa**; nodo de la Capa 5 de difusión masiva |
| **Radiobases bibanda (proyectadas)** | Colón 80, Escuelas Medias, Campus Palihue | Expansión de cobertura sujeta a pruebas de campo (7.1) |
| **Radiobase móvil** | Unidad vehicular + kit Starlink | Repetidor temporal ante caída del troncal (4.8); área proveedora del vehículo a designar por resolución del CDE |
...
| Aspecto | Disposición |
| --- | --- |
| **Titularidad y contrato** | La cuenta, el contrato de servicio y el equipamiento son administrados por la Dirección General de Telecomunicaciones, con un responsable titular y un suplente designados |
| **Operadores entrenados** | Mínimo dos operadores por turno potencial (Telecomunicaciones o LH) con instrucción registrada en despliegue, apuntamiento y puesta en servicio |
| **Despliegue y apuntamiento** | El kit se transporta en la unidad vehicular designada; se despliega en exterior con horizonte despejado hacia el sector de paso satelital, sobre mástil o techo del vehículo, con alimentación del vehículo o inversor dedicado; tiempo objetivo de puesta en servicio: menor a 30 minutos |
| **Usos habilitados** | Salida a internet para emisión de comunicados web y consulta de radares; réplica Alem↔Palihue de servicios críticos; soporte de la Sala de Crisis. No se utiliza para tráfico administrativo ordinario |
...
| **Prueba** | Despliegue y apuntamiento completos con frecuencia trimestral (7.2), con registro de resultado y de tiempo de puesta en servicio |
...
- **Expansión de nodos:** radiobases bibanda proyectadas en Colón 80, Escuelas Medias y Campus Palihue, sujetas a resultado de las pruebas de campo (7.1).

---

## 5. PLAN DE TELECOMUNICACIONES OPERACIONALES (POT-RACUNS)

> **Marco de referencia:** Anexo "Plan de Telecomunicaciones Operacionales para Apoyo Federal" v1.0/2026 del Plan de Coordinación Federal ENOS 2026/2027 (Agencia Federal de Emergencias – DNOYL), adaptado al ámbito, los niveles de gestión y los medios de la UNS.

### 5.1. Datos generales y encuadre institucional
...
| --- | --- | --- |
| **REDUNDANCIA** | Toda comunicación crítica debe contar con medios alternativos | Arquitectura en 5 capas (4.9); energía triple por nodo (4.13); simplex de contingencia y repetidor temporal (4.8); respaldo satelital (4.10) |
| **PRIORIDAD** | Jerarquización del tráfico según criticidad operativa | Prioridad absoluta de CH1 para mando y emergencia; tráfico de trabajo en CH2/CH3 y memorias de grupo (4.11) |
| **INTEROPERABILIDAD** | Compatibilidad entre agencias y jurisdicciones | Enlace CH4 con COE Defensa Civil (4.5); convenio AM–FM UTN-FRBB (Documento C); proyección de radioclubes (4.15) |
| **SEGURIDAD Y TRAZABILIDAD** | Registro y control de comunicaciones relevantes | Anexo Técnico restringido (4.5); Libro de Prueba Radial (A.2); libro de guardia y registros de difusión (Documentos A y C); actas de entrega de equipos |
| **AUTONOMÍA OPERATIVA** | Capacidad de operar de forma independiente en entornos adversos | Red VHF propia con baterías 24–48 h, grupo electrógeno o paneles solares (4.13); enlace satelital autónomo (4.10) |

### 5.4. Estructura operativa en tres niveles

| Nivel | Función principal | Nodos y medios asociados en la UNS |
| --- | --- | --- |
| **Estratégico (Sala de Crisis / CDE)** | Toma de decisiones y coordinación interinstitucional | Sala de Crisis primaria SJ670 y alternativa Anexo Radio (4.4); BASE CENTRAL y BASE RECTORADO; troncal CH1; enlace satelital Starlink (4.10); difusión masiva AM/FM (Capa 5); telefonía institucional |
| **Operativo (Nodo Central / mayordomías)** | Coordinación táctica de personal y recursos; tráfico y registro | Nodo Central 24/7 (BASE CENTRAL); BASE PALIHUE; BASE LH; radiobases bibanda proyectadas; CH1–CH3; UHF de proximidad y subcapa de retransmisión (4.7) |
| **Táctico (cuadrillas y brigadas en terreno)** | Comunicación entre equipos de intervención propios y externos | Flota de 12 handies (4.6); simplex CH2/CH3; subcapa de retransmisión (4.7); radiobase móvil como repetidor temporal (4.8) |

### 5.5. Protocolos operativos básicos (activaciones)
...
2. **Activación del troncal RACUNS:** apertura de escucha permanente en CH1 y registro en libro de guardia (4.3, 4.11).
3. **Activación del enlace CH4** con el COE de Defensa Civil Bahía Blanca ante declaración de emergencia (4.5).
4. **Escalonamiento externo:** ante catástrofes que superen la capacidad universitaria, se solicitará la activación del servicio de radioaficionados a través de ENACOM y de los convenios con radioclubes (4.15), conforme al principio de subsidiariedad del SINAGIR.
5. **Redundancias progresivas:** las activaciones responden a establecer todas las redundancias posibles ante un incremento de la crisis o necesidad de escalonamiento operacional (4.8, 4.9, 4.10).
...
### 5.7. Plan de contingencia de comunicaciones

Ante la necesidad de contar con mayor respaldo ante la caída de la red principal, se procederá de la siguiente manera:

1. **Activar red de respaldo satelital o móvil** ante caída de la red principal → enlace Starlink (4.10) y radiobase móvil (4.8).
2. **Reasignar frecuencias si hay interferencia** → migración al simplex de contingencia y memorias alternativas del Anexo Técnico restringido (4.8).
3. **Enviar equipos portátiles de reemplazo a zonas críticas** → reserva H-12 con acta de entrega (4.6).
4. **Reportar daños y priorizar comunicaciones de mando y rescate** → prioridad de CH1 y registro de novedades (4.11, 5.9).
5. **Activación del servicio de radioaficionados a través de ENACOM** → convenios con radioclubes locales (4.15).

### 5.8. Agenda interna de contacto operativo

Telecomunicaciones mantendrá una **Agenda Interna de Contacto Operativo** actualizada (plantilla en **Anexo A.4**), con distribución restringida a los destinatarios del punto 1.2, que incluirá: área, función, nombre, teléfono y correo de los roles de 5.6 y de los enlaces institucionales (COE Defensa Civil, UTN-FRBB, radioclubes).

- **Verificación:** en cada prueba radial semanal (4.11).
- **Actualización:** ante todo cambio de personal o de función, dentro de las 24 horas.

### 5.9. Registro y mejora continua

- **Registrar las comunicaciones críticas:** libro de guardia radial (A.2), libro de guardia del Nodo Central (Documento A) y registros de difusión (Documento C).
- **Realizar revisiones post-incidente** para identificar oportunidades de mejora: informe post-activación de 72 horas (Documento A) con análisis técnico de comunicaciones.
- **Alimentar los indicadores** de la Sección 8 y la revisión anual del presente documento mediante control de versiones.
...
| Prueba | Frecuencia | Referencia |
| --- | --- | --- |
| Prueba radial semanal | Semanal | 4.11 / Anexo A.2 |
| Transmisión conjunta AM UNS – FM UTN-FRBB | Trimestral | Coordinada con la Vocería (Documento C) |
| Conmutación energética de nodos críticos (ATS, UPS, generador móvil) | Semestral | 4.13 |
| Procedimiento de caída del repetidor | Trimestral | 4.8 |
| Despliegue y apuntamiento del enlace Starlink | Trimestral | 4.10 |
| Simulacro integral con activación completa de RACUNS y Nodo Central | Anual | Documento A |
...
- Todo desvío se registrará y tratará conforme al ciclo **PDCA** del Documento A (Sección de Mejora Continua). El registro de comunicaciones críticas y las revisiones post-incidente se rigen por el Documento A y por 5.9.
...
### A.4. Agenda Interna de Contacto Operativo (plantilla – distribución restringida)

| Área | Función | Nombre | Teléfono | Email |
| --- | --- | --- | --- | --- |
| Telecomunicaciones | Coordinador técnico de Comunicaciones |  |  |  |
| Nodo Central SJ670 | Operador de Central de tráfico – turno 24/7 |  |  |  |
| LH / Infraestructura | Soporte técnico y logístico de campo |  |  |  |
| Mayordomía SJ670 | BASE CENTRAL |  |  |  |
| Mayordomía Palihue | BASE PALIHUE |  |  |  |
| Laboratorio de Hidráulica | BASE LH |  |  |  |
| Anexo Radio | BASE ANEXO RADIO / operadores AM |  |  |  |
| Enlace institucional | COE Defensa Civil Bahía Blanca (CH4) |  |  |  |
