...
> **Nota de segregación:** el presente documento integra el contenido técnico y de ingeniería del protocolo. Los aspectos operativos de decisión, custodia y el régimen funcional de la Oficina de Recepción de Avisos 24/7 se rigen por el **Documento A (Protocolo Operativo)**; los aspectos de difusión, vocería, mensajes, formatos accesibles y medios comerciales de notificación se rigen por el **Documento C (Manual de Comunicación Pública)**.
...
Este documento es de uso obligatorio para: **Dirección General de Telecomunicaciones**, **Subsecretaría de Infraestructura y Servicios**, **Laboratorio de Hidráulica del Departamento de Ingeniería (LH)**, **mayordomías de todos los predios**, **Seguridad Patrimonial**, **brigadas técnicas** y **técnicos de Radio AM UNS designados por la Vocería**.
...
- **Nodo Meshtastic Palihue:** nodo único de malla LoRa desplegado en Campus Palihue, de ubicación estratégica en Bahía Blanca y autonomía energética solar (ver 4.9, Capa 5).
...
| **ANEXO RADIO (Campus Radio)** | Edificio Anexo de la Radio AM UNS | Radiobase fija bibanda integrada al troncal; cadena de transmisión AM con respaldo energético; **Sala de Crisis alternativa**; nodo de la Capa 4 de difusión masiva; portador del nodo Starlink **S2** (4.10) |
| **Radiobases bibanda (proyectadas)** | Nodos Colón 80, Escuelas Medias y Campus Palihue | Expansión de cobertura sujeta a pruebas de campo (6.1) |
| **Radiobase móvil** | Unidad vehicular designada | Equipo bibanda + kit Starlink **S3** (4.10); repetidor temporal ante caída del troncal (4.8) |
...
| **Prueba** | El procedimiento completo se ejercita con frecuencia trimestral (6.2), incluyendo migración, repetidor temporal y restitución |

### 4.9. Arquitectura en capas (redundancia funcional)

| Capa | Tecnología | Rol | Estado | Fortalezas / límites |
| --- | --- | --- | --- | --- |
| **1 – Troncal** | VHF repetidora (Alem, 50 W) + bases fijas (SJ670, Colón 80, Palihue, LH, Anexo Radio) | Mando y emergencia (CH1) | Operativa | Línea de vista, cobertura urbana; ante caída del repetidor opera 4.8 |
| **2 – Proximidad** | UHF simplex / rebotes | Interior de edificios, sombra radioeléctrica | Operativa | Penetra hormigón; menor alcance |
| **3 – Datos** | Starlink en tres modalidades: **S1** respaldo fijo, **S2** nodo Anexo Radio, **S3** kit móvil (4.10) | Internet de contingencia; réplica de servidores Alem↔Palihue; emisión de comunicados web; enlace alternativo AM–FM | Operativa | Satelital, independiente; requiere apuntamiento y energía; conmutación manual en S1 |
...
### 4.10. Enlace satelital de contingencia (Starlink): tres modalidades
...
- **Prueba:** simulacro trimestral de conmutación manual con medición de tiempos (6.2).
...
- **Prueba:** prueba trimestral de emisión vía S2 y del enlace alternativo con la FM (6.2).
...
- **Rol radial:** ante caída del repetidor principal asume el rol de repetidor temporal (4.8).
...
- **Expansión de nodos:** radiobases bibanda proyectadas en Colón 80, Escuelas Medias y Campus Palihue, sujetas a resultado de las pruebas de campo (6.1); evaluación de nodos Meshtastic adicionales sujeta a prueba del nodo único existente.
- **Notificaciones masivas:** se registra el servicio **Alerthor (tercero)** y el **proyecto de desarrollo de un sistema propio** de similares características para evitar cautividad tecnológica. La definición de los medios comerciales de transmisión de la información del proceso (Alerthor, sistema propio, WhatsApp, Telegram, correo, SMS, llamadas y futuros desarrollos) se establece en el **Documento C**.
...
```
  ...
  [ENLACE S1] ── servidores Alem ↔ respaldo Palihue ·
        conmutación MANUAL ante degradación de fibra (4.10)
  [NODO MESH PALIHUE] ── Capa 5 · único · autónomo solar (4.9)
```
...
| --- | --- | --- |
| Prueba radial semanal (4.11) | Semanal | Telecomunicaciones |
...
| Procedimiento de caída del repetidor (4.8) | Trimestral | Telecomunicaciones |
| Despliegue y apuntamiento Starlink S3 (4.10) | Trimestral | Telecomunicaciones |
| **Conmutación MANUAL del enlace S1 fibra→Starlink (4.10)** | Trimestral | Telecomunicaciones |
| **Emisión vía Starlink S2 y enlace alternativo con la FM (4.10)** | Trimestral | Vocería + Telecomunicaciones |
| Verificación del nodo Meshtastic Palihue (4.14) | Semestral | Telecomunicaciones + LH |
