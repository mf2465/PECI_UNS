...
**Revisión 0 – Versión 6 (Consolidado Institucional 2026)**
...
| 0 | 5 | 09/2026 | Corrección editorial integral: formato Markdown estructurado, depuración de erratas y espacios intrusivos, normalización de referencias cruzadas, tablas de registro y diagrama de topología |
...
- **Degradación parcial:** falla de uno o más medios primarios sin caída general. Se aplica el orden de uso de 4.4 (7) y el Nodo Central registra medios afectados y flujos reasignados.
- **Estado de Comunicaciones Degradadas:** caída o inutilización de los medios convencionales (telefonía celular, internet y/o energía de red), verificada por el Nodo Central y declarada por el CDE conforme a 5.3. RACUNS pasa a ser medio principal de coordinación; los medios primarios quedan relegados a uso oportunista cuando recuperen servicio.
- **Traspaso:** declarada la degradación, el Nodo Central notifica el cambio de medio principal a todos los actores por RACUNS y por todo medio primario aún operativo, asentando hora y medios en el libro de guardia.
- **Retorno:** verificada la estabilidad de los medios primarios, Telecomunicaciones ejecuta pruebas de servicio, notifica el retorno por ambos sistemas y registra el cierre del período de degradación; RACUNS retoma su rol alternativo.
